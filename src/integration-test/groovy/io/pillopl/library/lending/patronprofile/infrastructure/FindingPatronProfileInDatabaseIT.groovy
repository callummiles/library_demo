...
class FindingPatronProfileInDatabaseIT extends Specification {
    ...
    void thereIsOnlyOneHold(PatronProfile profile) {
        ...
        assert actualHold.till.truncatedTo(java.time.temporal.ChronoUnit.MILLIS) == TOMORROW.truncatedTo(java.time.temporal.ChronoUnit.MILLIS)
    ...
    void thereIsOnlyOneCheckout(PatronProfile profile) {
        ...
        assert actualCheckout.till.truncatedTo(java.time.temporal.ChronoUnit.MILLIS) == TOMORROW.truncatedTo(java.time.temporal.ChronoUnit.MILLIS)
    }
